 ...
 ?>
	...
	<body>
		...
		<div class="container">
         ...
         echo "<td><a href=\"thanhtoan.php\" class=\"btn btn-success btn-block\">Đặt hàng <i class=\"fa fa-angle-right\"></i></a></td>";
         echo "</tr>";

         echo "<tr>";
         echo "<td><a href=\"category.php\" class=\"btn btn-success btn-block\">Chọn sản phẩm <i class=\"fa fa-angle-right\"></i></a></td>";
         echo "</tr>";
     } ?>
				</tbody>
			</table>
