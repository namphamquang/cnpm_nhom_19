...
if ($submit === 'yes') {
   ...
   // }
    ...
    $canRegister = empty($validateError['username']) && empty($validateError['password']) && empty($validateError['fullname']) && empty($validateError['phone']) && empty($validateError['email']);
            ...
            <div class="container">
                <div class="register-form">
                    <form action="" method="post">
                        ...
                        <div class="input-box">
                            <?= !empty($validateError['fullname']) ? "<p class='error'>" . implode("<br/>", $validateError['fullname']) . "</p>" : "" ?>
