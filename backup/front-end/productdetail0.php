            ...
            <div class="wrapper row">
               <div class="preview col-md-6">
                  <div class="preview-pic tab-content">
                     <div class="tab-pane active" id="pic-1"><img src="imagesp/0_0.webp" /></div>
                  ...
                  <ul class="preview-thumbnail nav nav-tabs">
                     <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="imagesp/0_0.webp" /></a></li>
               ...
               <div class="details col-md-6">
                  <h3 class="product-title">Nike Air Monarch IV</h3>
                  <p> Giày tập nam
                  <p>
                  <div class="rating">
                  ...
                  <ol>
                     ...
                     <li>Solid rubber sole is durable and provides traction over varied surfaces.
                        <ol>
                           ...
                           <h4 class="price">Giá bán: <span>1.469.000 đ</span></h4>
                           <form method="POST" action="">
                              ...
                              <input type="hidden" name="name" value="Nike Air Monarch IV">
                              <br>
